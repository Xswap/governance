...
contract XswapFeeTo {
    ...
    function setOwner(address owner_) public {
        require(msg.sender == owner, 'XswapFeeTo::setOwner: not allowed');
        owner = owner_;
    }

    function setFeeRecipient(address feeRecipient_) public {
        require(msg.sender == owner, 'XswapFeeTo::setFeeRecipient: not allowed');
        feeRecipient = feeRecipient_;
    }

    function updateTokenAllowState(address token, bool allowed) public {
        require(msg.sender == owner, 'XswapFeeTo::updateTokenAllowState: not allowed');
