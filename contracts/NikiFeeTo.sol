...
contract NikielFeeTo {
    ...
    function setOwner(address owner_) public {
        require(msg.sender == owner, 'NikielFeeTo::setOwner: not allowed');
        owner = owner_;
    }

    function setFeeRecipient(address feeRecipient_) public {
        require(msg.sender == owner, 'NikielFeeTo::setFeeRecipient: not allowed');
        feeRecipient = feeRecipient_;
    }

    function updateTokenAllowState(address token, bool allowed) public {
        require(msg.sender == owner, 'NikielFeeTo::updateTokenAllowState: not allowed');
